...
--
-- Host: localhost:3306
-- Waktu pembuatan: 12 Jan 2023 pada 23.01
...
('7db813c90942', 'CRISTMAS SALE', 'All Item UP TO 35%', 'home');
...
(23, '7db813c90942', '20221219_192102_0000.png');
...
INSERT INTO `pesanan` (`id_pesanan`, `id_user`, `tanggal_pesanan`, `total_pesanan`, `status_pesanan`, `contact_number`, `contact_address`) VALUES
('0A8FEE12CB34', 6, '1671639410', '40', 4, '', ''),
('3614A5D7FAE3', 6, '1671641347', '40', 1, '605 067 836', 'Preislerova 80 Králův Dvůr Popovice '),
('C749F03BF8CE', 6, '1671639348', '40', 0, '', ''),
('E6B5AB7C4AC9', 6, '1671640933', '40', 1, '605 067 836', 'Králův Dvůr Popovice Preislerova 80  ');
...
INSERT INTO `pesanan_detail` (`id_detail`, `id_pesanan`, `id_produk`, `qty`, `harga_item`) VALUES
(6, 'C749F03BF8CE', '5a31ca90784f', 1, '40'),
(7, '0A8FEE12CB34', '2f3d2e1404f0', 1, '40'),
(8, 'E6B5AB7C4AC9', '5a31ca90784f', 1, '40'),
(9, '3614A5D7FAE3', '5a31ca90784f', 1, '40');
...
(6, 'Petr', 'petavlcek10@gmail.com', 'user.png', '$2y$10$JaPiphmWnmy3vW4ZB2N09O4spCxqjkjf/nNv3l67QKOm5Osk9u3lu', 'Czechia', 2, 1, '1671639332', 0);
...
--
ALTER TABLE `content_image`
  MODIFY `id_content_image` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
